  ...
  (response) => {
    ...
    if (isHTML) {
      ...
      error.response = {
        ...
        data: {
          message:
            "Received HTML response instead of JSON. Backend URL may be incorrect. Please check Railway frontend is using the correct backend URL.",
        },
      };
      return Promise.reject(error);
    }
